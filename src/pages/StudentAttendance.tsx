                ...
                <CardContent className="space-y-6">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-1">Current Status: <span className="text-green-600 font-medium">Checked in</span></p>
                      ...
                      {attendanceHistory.map((record, index) => (
                        <tr key={index} className="border-b border-border hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <Badge className={`${record.statusColor} border-0`}>
                              {record.status}
                            </Badge>
                          </td>
                        </tr>
