                    ...
                    <tbody>
                      {weeklySchedule.map((row, index) => (
                        <tr key={index} className="border-b border-gray-100">
                          ...
                          <td className="p-3">
                            <Badge className={`${row.monday.color} border-0 px-3 py-1 text-xs`}>
                              {row.monday.type}
                            </Badge>
                          </td>
                          <td className="p-3">
                            <Badge className={`${row.tuesday.color} border-0 px-3 py-1 text-xs`}>
                              {row.tuesday.type}
                            </Badge>
                          </td>
                          <td className="p-3">
                            <Badge className={`${row.wednesday.color} border-0 px-3 py-1 text-xs`}>
                              {row.wednesday.type}
                            </Badge>
                          </td>
                          <td className="p-3">
                            <Badge className={`${row.thursday.color} border-0 px-3 py-1 text-xs`}>
                              {row.thursday.type}
                            </Badge>
                          </td>
                          <td className="p-3">
                            <Badge className={`${row.friday.color} border-0 px-3 py-1 text-xs`}>
                              {row.friday.type}
                            </Badge>
                          </td>
                        </tr>
