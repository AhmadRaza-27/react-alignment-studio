...
import { LayoutDashboard, Users, ClipboardList, FileText, Calendar, LogOut, BarChart3, Plus } from "lucide-react";
  ...
  const TaskCard = ({ task, status }: { task: any; status: string }) => {
    const getCardBg = () => {
      switch (status) {
        ...
        case 'inProgress': return 'bg-purple-50 border-purple-200';
