...
import { LayoutDashboard, Users, ClipboardList, FileText, Calendar, LogOut, BarChart3 } from "lucide-react";
...
const AdminTimetable = () => {
  ...
  const weeklySchedule = [
    ...
    {
      time: "11:00-\n11:30 AM",
      monday: { type: "break", text: "LUNCH BREAK" },
      tuesday: { type: "break", text: "LUNCH BREAK" },
      wednesday: { type: "break", text: "LUNCH BREAK" },
      thursday: { type: "break", text: "LUNCH BREAK" },
      friday: { type: "break", text: "LUNCH BREAK" }
    },
    {
      time: "12:30-\n1:20 PM",
      monday: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Avatar className="w-8 h-8">
                  <AvatarFallback className="bg-gray-200 text-gray-600 text-xs">AD</AvatarFallback>
                </Avatar>
        ...
        <main className="p-6">
          {/* Page Title */}
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900">Weekly Schedule - Intern Availability</h2>
            <p className="text-sm text-gray-500">Week of December 23-27, 2025 (50-minute periods)</p>
          </div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">MONDAY</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">TUESDAY</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">WEDNESDAY</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">THURSDAY</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">FRIDAY</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-100">
                    {weeklySchedule.map((row, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="px-4 py-4 font-semibold text-sm text-gray-700 whitespace-pre-line">{row.time}</td>
                          ...
                          {Array.isArray(row.monday) ? (
                            <div className="space-y-1">
                              {row.monday.map((item, i) => (
                                <Badge key={i} className={`${item.color} border-0 text-xs px-2 py-1 block w-fit`}>
                                  {item.text}
                                </Badge>
                              ))}
                            </div>
          ...
          <Card className="border border-gray-200">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-gray-900">All Interns (24 Total)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center space-x-4">
                {allInterns.map((intern, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      {intern.date && <div className="text-xs text-gray-500">{intern.date}</div>}
                    </div>
                  </div>
                ))}
              </div>
