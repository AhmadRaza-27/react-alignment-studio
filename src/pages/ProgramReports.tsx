...
const ProgramReports = () => {
  ...
  const todaysInterns = [
    { name: "Ahmed Ali", attendance: "Present", tasks: "8/12", attendanceColor: "text-green-600", attendanceBg: "bg-green-100" },
    { name: "Sarah Khan", attendance: "Present", tasks: "6/10", attendanceColor: "text-green-600", attendanceBg: "bg-green-100" },
    { name: "Ali Hassan", attendance: "Absent", tasks: "4/8", attendanceColor: "text-red-600", attendanceBg: "bg-red-100" },
    { name: "Fatima Sheikh", attendance: "Present", tasks: "7/9", attendanceColor: "text-green-600", attendanceBg: "bg-green-100" },
    { name: "Omar Malik", attendance: "Absent", tasks: "3/7", attendanceColor: "text-red-600", attendanceBg: "bg-red-100" }
  ];
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Avatar className="w-8 h-8">
                  <AvatarFallback className="bg-gray-200 text-gray-600 text-xs">AU</AvatarFallback>
                </Avatar>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border border-gray-200">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-semibold text-gray-900">Interns(Today)</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  {tasksOverview.map((task, index) => (
                    <div key={index} className="grid grid-cols-3 gap-4 py-3 border-b border-gray-100">
                      <div className="col-span-2">
                        <div className={`text-sm font-medium ${task.taskColor} mb-1`}>{task.task}</div>
